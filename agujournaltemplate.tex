...
The finding that climate change reduces summer Q10 by a median of 24\% across the region — with the most vulnerable catchments losing more than 80\% of their already-low summer baseflow — has direct implications for Water Act permitting timelines and investment decisions. Hydrogen production facilities with planned operational lifetimes of 20--30 years will be exposed to substantially different hydrological conditions from those prevailing at the time of permitting. We discuss how Water Act permitting thresholds, cumulative-impact considerations, and groundwater protection constraints interact with hydrogen deployment timelines and infrastructure planning.

\subsection{Social dimensions and distributional impacts}
The opposing seasonal trends under climate change — winter improvement, summer-autumn deterioration — and the clear spatial gradient from constrained western to more available eastern catchments create distributional equity considerations. We analyse potential social effects of freshwater withdrawals for hydrogen production, including perceptions of a zero-sum competition with municipal supply, agriculture, ecosystem needs, and public acceptance constraints for MAR and new water infrastructure.
